...
$query 	= "SELECT * FROM puti_members WHERE deleted <> 1 AND status = 1 AND sess_id = '" . $db->quote($_REQUEST["publicSession"]) . "'";
$result = $db->query($query);
$row 	= $db->fetch($result);
$member_id = $row["id"]!=""?$row["id"]:-1;

$query 	= "SELECT * FROM puti_members_lang WHERE member_id = '" . $db->quote($member_id) . "'";
...
$query 	= "SELECT * FROM puti_members_others WHERE member_id = '" . $db->quote($member_id) . "'";
$result_others = $db->query($query);
$row_others = $db->fetch($result_others);

$query 	= "SELECT * FROM puti_members_hearfrom WHERE member_id = '" . $db->quote($member_id) . "'";
...
$query 	= "SELECT * FROM puti_members_symptom WHERE member_id = '" . $db->quote($member_id) . "'";
			  ...
			  $("#btn_submit").bind("click", function(ev) {
				  ...
				  $.ajax({
					  ...
					  error: function(xhr, tStatus, errorTh ) {
				  		  $("#wait").loadHide();
						  alert("Error (level1_form_save.php): " + xhr.responseText + "\nStatus: " + tStatus);
					  },
...
<?php } ?>
					...
					<tr>
                    	...
                    	<td colspan="3" align="left">
                         	<?php 
								...
								echo 
								cHTML::radio('member_lang',$rows_lang, $row["language"]);
							?>
                        </td>
                    </tr>
					<tr>
                    	...
                    	<td colspan="3" align="left">
                         	<?php 
								...
								$rows_lang = $db->rows($result_lang);
								echo 
								cHTML::checkbox('language',$rows_lang,6, $langs);
							?>
                        </td>
                    </tr>
            ...
            <td valign="top" width="50%" style="border:1px solid #cccccc;">
            	<table cellpadding="2" cellspacing="0" width="100%">
					<tr>
                    	<td colspan="2" class="line"><b><?php echo cTYPE::gstr($words["contact information"])?>:</b> <span class="required">*</span></td>
                    </tr>
                	<tr>
                    	 <td class="title"><?php echo cTYPE::gstr($words["phone"])?>: </td>
                    	 <td>
                         	<input class="form-input" id="phone" name="phone" value="<?php echo cTYPE::gstr($row["phone"])?>" />
                         </td>
                    </tr>
                	<tr>
                    	 <td class="title"><?php echo cTYPE::gstr($words["cell"])?>: </td>
                    	 <td>
                         	<input class="form-input" id="cell" name="cell" value="<?php echo cTYPE::gstr($row["cell"])?>" />
                         </td>
                    </tr>
                	<tr>
					...
					<tr>
                        ...
                        <td>
                        	<input class="form-input" id="emergency_name" name="emergency_name" value="<?php echo cTYPE::gstr($row_others["emergency_name"])?>" />
                            <span class="required">*</span>
                        </td>
                    </tr>
					<tr>
                        ...
                        <td>
                        	<input class="form-input" id="emergency_phone" name="emergency_phone" value="<?php echo cTYPE::gstr($row_others["emergency_phone"])?>" />
                            <span class="required">*</span>
                        </td>
                    </tr>
					<tr>
                        ...
                        <td>
                        	<input class="form-input" id="emergency_ship" name="emergency_ship" value="<?php echo cTYPE::gstr($row_others["emergency_ship"])?>" />
                        	<span class="required">*</span>
                        </td>
                    </tr>
					...
					<tr>
                    	<td colspan="2" class="line"><b><?php echo cTYPE::gstr($words["how did you hear about us?"])?> <span class="required">*</span></b></td>
                    </tr>
					<tr>
                    	<td colspan="2" align="left">
                         	<?php 
					...
					<tr>
                    	<td colspan="2" class="line"><b><?php echo cTYPE::gstr($words["ailment & symptom"])?></b></td>
                    </tr>
					<tr>
                    	<td colspan="2" align="left">
                         	<?php 
