...
$query = "SELECT c.template as logform FROM event_calendar a  INNER JOIN puti_class b ON (a.class_id = b.id) INNER JOIN puti_forms c ON(b.logform = c.id) WHERE a.id = '" . $db->quote($_REQUEST["loginform_event_id"]) . "'";
