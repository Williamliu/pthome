...
function member_detail_clear() {
		  ...
		  htmlObj.checkbox_clear("language");
			...
			if( req.errorCode > 0 ) { 
				...
				$("#diaglog_member_detail").diagShow({
					  diag_open: function() {
							...
							htmlObj.checkbox_set("language", req.data.languages);
			            	...
			            	<table border="0" cellpadding="1" cellspacing="0">
							 ...
							 ?>   
                              ...
                              ?>
                                    ...
                                    <tr><td colspan="4" style="border-top:1px solid #aaaaaa"></td></tr>
                
                                    <tr>
                                         <td class="title"><?php echo $words["email"]?>: </td>
                                         <td colspan="3">
                                            <input class="form-input" id="email" name="email" value="" />
                                            <span style="margin-left:10px;"><?php echo $words["email subscription"]?>: </span>
                                    ...
                                    <tr>
                                         ...
                                         <td colspan="3">
                                            ...
                                            <span style="margin-left:10px;"><?php echo $words["cell"]?>: </span>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <span style="margin-left:20px;">
                                                         <?php echo $words["memo notes"]?>: 
                                                        </span>
                                                        <input class="form-input" style="width:150px;" id="memo" name="memo" value="" />
                                                    </td>
                                                 </tr>
                                              </table>
                                        </td>
                            	...
                            	<tr>
                                          <td valign="top">
                                                  <table border="0" cellpadding="1" cellspacing="0">
                                                      ...
                                                      <tr>
                                                           <td class="title"><?php echo $words["id card"]?>: </td>
                                                           <td>
                                          ...
                                          <td valign="top" align="left" style="padding-left:10px;">
                                                <?php echo $words["id card list"]?>:
                                                <div id="id_card_list" style="height:80px; width:280px; overflow:auto; border:1px dotted #cccccc;"></div>
                                          </td>
                                </tr>
                            </table>
                        </td>
								...
								<tr>
                                	<td valign="top">
                                   	...
                                   	<td valign="top" style="padding-left:20px;">
                                        ...
                                        <br />
                                        <a id="original_url" href="" style="display:block; font-size:16px; color:blue; text-decoration:underline; padding-top:10px;">
                                    	<?php echo $words["photo original download"]?>
                                        </a>
                                        <a id="large_url" href="" style="display:block; font-size:16px; color:blue; text-decoration:underline; padding-top:10px;">
                                    	<?php echo $words["photo large download"]?>
                                        </a>
                                        <a id="medium_url" href="" style="display:block; font-size:16px; color:blue; text-decoration:underline; padding-top:10px;">
                                    	<?php echo $words["photo medium download"]?>
                                        </a>
                                        <a id="small_url" href="" style="display:block; font-size:16px; color:blue; text-decoration:underline; padding-top:10px;">
