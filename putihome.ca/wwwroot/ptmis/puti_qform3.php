...
<head>
		...
		function quick_ajax() {
			...
			$("form[name='form_register']").attr("action", "<?php echo $CFG["http"] . $CFG["admin_domain"];?>/event_calendar_enroll_camera.php");
...
<div>
    ...
    <table border="0" width="100%">
    	<tr>
        	<td valign="top" width="50%" style="border:1px solid #999999;">
