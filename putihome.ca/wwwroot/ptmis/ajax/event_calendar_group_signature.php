				...
				<tr>
                  	<td valign="top">' . $words["preferred language"] . ' <span class="required">*</span>: </td>
                    	<td colspan="3" align="left">' .
								cHTML::checkbox('member_lang',$rows_langs,2, array($row["language"]))
                        . '</td>
                    </tr>
					<tr>
 	                  	<td valign="top">' . $words["language ability"] . ': </td>
                    	<td colspan="3" align="left">' .
								cHTML::checkbox('language',$rows_langs,2, $mem_langs)
                        . '</td>
                    </tr>';
    ...
    */
	$html.= '<tr>
				<td colspan="2"  style="border-top:0px; border-bottom:0px;"><br>
                    ...
                    <center>
                	    <input type="checkbox" id="irefuse" ' . ($row["email_flag"]?"":"") . ' 	name="email_flag" value="0" /><label for="irefuse"><b>' . $words["i dont agree"] . '</b></label>
                        <input type="checkbox" id="iagree" ' . ($row["email_flag"]?"":"") . '	name="email_flag" value="1" style="margin-left:50px;" /><b>' . $words["i agree"] . '</b></label>
              	    </center><br>
                </td>
			 </tr>';
