...
try {
	...
	// header stuff	
	$eid = $con["event_id"];
	$query00 = "SELECT  event_id, id as event_date_id, yy, mm, dd, event_date, checkin, day_no FROM event_calendar_date WHERE event_id = '" . $eid . "' ORDER BY day_no";
	...
	$query_base = "SELECT  a.id as enroll_id, a.event_id, a.unauth, a.trial, a.group_no, a.online, a.signin, a.graduate, a.cert, attend,
