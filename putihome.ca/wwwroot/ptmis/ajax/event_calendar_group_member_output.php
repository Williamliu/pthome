...
try {
	...
	$query = "SELECT a.id as enroll_id, a.created_time as enroll_date, a.confirm, a.shelf, a.trial, b.id, b.id as member_id, b.first_name, b.last_name, b.dharma_name, b.dharma_pinyin, b.alias, b.language, b.birth_yy, b.member_yy, b.member_mm, b.member_dd, b.memo, b.legal_first, b.legal_last, b.age, b.gender, b.email, b.phone, b.cell, b.city, b.site, a.group_no,
	...
	$html.= '<tr>';
	$html.= '<td colspan="33" align="center" height="40" style="font-size:16px; border:0px; font-weight:bold;">' . cTYPE::gstr($row0["title"]) . '<br>[ ' . date("M d, Y", $row0["start_date"]) . ($row0["start_date"]>0?' ~ ' .date("M d, Y", $row0["end_date"]):'') .  ' ]</td>';
	$html.= '</tr>';
	...
	//$html.= '</tr>';
	$html.= '<tr>';
	$html.= '<td colspan="33" style="font-size:16px; font-weight:bold;">' . cTYPE::gstr($words["total"]) . ': ' . $cnt . '</td>';
	$html.= '</tr>';
