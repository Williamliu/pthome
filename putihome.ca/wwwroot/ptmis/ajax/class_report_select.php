...
try {
	...
	$query_base = "SELECT a.id as event_id, a.title, a.start_date, a.end_date,
						  ...
						  c.first_name, c.last_name, c.dharma_name, c.alias, c.gender, c.email, c.phone, c.cell, c.city , c.member_title 
	...
	while( $row = $db->fetch($result)) {
		...
		//$rows[$cnt]["start_date"]	= $rows[$cnt]["start_date"] . ($rows[$cnt]["end_date"]!=""?"<br>":"") . $rows[$cnt]["end_date"];
