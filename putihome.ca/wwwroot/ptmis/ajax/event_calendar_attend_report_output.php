...
try {
	...
	$query2 	= "SELECT round(sum(attend)/sum(if(attend>0,1,0)),2) as attend, count(a.id) as enroll, sum(a.trial) as trial
	...
	$html .= '<tr>';
	$html .= '<td ' . $width_one . ' ' . $header_css . ' colspan="10" align="center"><span style="font-size:14px; font-weight:bold;">Event Report<br>' . $period . '</span></td>';
	$html .= '</tr>';
