...
try {
	...
	$html .= '<tr>';
	$html .= '<td ' . $width_one . ' ' . $header_css . ' colspan="23" align="center"><span style="font-size:12px; font-weight:bold;">Class History Detail Report<br>' . $class_title . ' [' . $period . ']</span></td>';
	$html .= '</tr>';
