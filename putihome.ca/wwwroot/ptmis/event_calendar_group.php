		...
		$(function(){
			ungroupObj = new LWH.cTABLE({
										  ...
										  headers:[
											  ...
											  {title: words["new people"], 	col:"new",		    align:"center"},
                                        ...
                                        <td valign="top">
                                              <table cellpadding="1" cellspacing="0">
                                                  ...
                                                  <tr>
                                                      ...
                                                      <td>
                                                          <!--
                                                           <select oper="search" id="sch_onsite">
                                                                <option value=""></option>
                                                                <option value="1"><?php echo $words["yes"]?></option>
                                                                <option value="0"><?php echo $words["no"]?></option>
                                                            </select>    
                                                        ...
                                                        <td>											
                                                              <select id="sch_lang" style="text-align:center;" name="sch_lang">
                                                                  <option value=""></option>
                                                                  <?php
                                                                      $result_lvl = $db->query("SELECT * FROM puti_info_language order by id");
                                                                      while( $row_lvl = $db->fetch($result_lvl) ) {
                                                                          echo '<option value="' . $row_lvl["id"] . '">' . $words[$row_lvl["title"]] . '</option>';
                                                                      }
                                                                  ?>
                                                              </select>
                                                         </td>
