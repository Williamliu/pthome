...
<head>
		...
		$(function(){
			  ...
			  allObj = new LWH.cTABLE({
										  ...
										  url:		"ajax/event_calendar_leave_select.php",
										  cache:	false,
										  expire:	3600,
		...
		function headHTML(obj, others) {
			...
			var html = '';
			html += '<tr>';
			html += '<td colspan="' + (9 + hcnt) + '" align="center"><span style="font-size:12px; font-weight:bold;">' + words["menu_leave"] + '</span></td>';
			html += '</tr>';
		...
		function save_ajax() {
				  ...
				  $.ajax({
					  ...
					  error: function(xhr, tStatus, errorTh ) {
				  		  $("#wait").loadHide();
						  alert("Error (event_calendar_leave_save.php): " + xhr.responseText + "\nStatus: " + tStatus);
					  },
					  ...
					  type: "post",
					  url: "ajax/event_calendar_leave_save.php"
				  });
		}
