...
<head>
		...
		function jsonToHTML( evtObj ) {
				...
				html += '<tr>';
				html += '<td colspan="12" align="center"><span style="font-size:12px; font-weight:bold;">' + words["event attendance report"] + '</span></td>';
				html += '</tr>';
				html += '<tr>';
...
/*				html += '<td class="tabQuery-table-header" rowspan="2" title="打卡次数">' + words["punch.tm"] + '</td>';
				html += '<td class="tabQuery-table-header" rowspan="2" title="打卡人数">' + words["punch.pp"] + '</td>'; */
