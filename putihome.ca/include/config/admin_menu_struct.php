...
// below is gabage
/*
$menu["menu"][700]["menu"][30] 	= array("name"=>"Add Volunteer",	"tpl"=>"volunteer_add_engroup.php", 	"url"=>"", "title"=>"", "desc"=>"");
$menu["menu"][700]["menu"][40] 	= array("name"=>"Hours Input",		"tpl"=>"volunteer_hours_engroup.php", 	"url"=>"", "title"=>"", "desc"=>"");
$menu["menu"][700]["menu"][50] 	= array("name"=>"Hours Adjust",	"tpl"=>"volunteer_hours_edit_engroup.php", 	"url"=>"", "title"=>"", "desc"=>"");

$menu["menu"][3] = array("name"=>"义工管理", "url"=>"", "tpl"=>"", "title"=>"", "desc"=>"");
$menu["menu"][3]["menu"] 	= array();
$menu["menu"][3]["menu"][0] = array("name"=>"部门定义", 		"tpl"=>"puti_department.php",			"url"=>"", "title"=>"", "desc"=>"");
$menu["menu"][3]["menu"][1] = array("name"=>"添加义工",  		"tpl"=>"volunteer_add.php", 			"url"=>"", "title"=>"", "desc"=>"");
$menu["menu"][3]["menu"][2] = array("name"=>"所有义工清单",  	"tpl"=>"volunteer_list.php", 			"url"=>"", "title"=>"", "desc"=>"");
$menu["menu"][3]["menu"][3] = array("name"=>"工时输入-所有部门",  	"tpl"=>"volunteer_hours.php", 			"url"=>"", "title"=>"", "desc"=>"");
$menu["menu"][3]["menu"][4] = array("name"=>"工时报表-按部门", 	"tpl"=>"volunteer_department_report.php", 			"url"=>"", "title"=>"", "desc"=>"");
$menu["menu"][3]["menu"][5] = array("name"=>"工时报表-按义工",  	"tpl"=>"volunteer_volunteer_report.php", 			"url"=>"", "title"=>"", "desc"=>"");
$menu["menu"][3]["menu"][6] = array("name"=>"年度报表-按部门",   "tpl"=>"volunteer_depyear_report.php", 			"url"=>"", "title"=>"", "desc"=>"");
$menu["menu"][3]["menu"][7] = array("name"=>"年度报表-按义工",   "tpl"=>"volunteer_volyear_report.php", 			"url"=>"", "title"=>"", "desc"=>"");
$menu["menu"][3]["menu"][8] = array("name"=>"工时输入-本部门",  	"tpl"=>"volunteer_hours_admin.php", 			"url"=>"", "title"=>"", "desc"=>"");
$menu["menu"][3]["menu"][9] = array("name"=>"工时核对调整-本部门","tpl"=>"volunteer_hours_edit.php", 				"url"=>"", "title"=>"", "desc"=>"");
$menu["menu"][3]["menu"][10] = array("name"=>"工时报表-本部门",  "tpl"=>"volunteer_department_admin.php", 		"url"=>"", "title"=>"", "desc"=>"");
$menu["menu"][3]["menu"][11] = array("name"=>"年度报表-按部门",   "tpl"=>"volunteer_depyear_report1.php", 		"url"=>"", "title"=>"", "desc"=>"");
$menu["menu"][3]["menu"][12] = array("name"=>"年度报表-按义工",   "tpl"=>"volunteer_volyear_report1.php", 			"url"=>"", "title"=>"", "desc"=>"");

$right["right"][3] = array("view"=>1);
$right["right"][3]["right"] 	= array();
$right["right"][3]["right"][0] = array("view"=>1, "add"=>1, "save"=>1, "delete"=>1);
$right["right"][3]["right"][1] = array("view"=>1, "save"=>1);
$right["right"][3]["right"][2] = array("view"=>1, "save"=>1, "delete"=>1, "print"=>1);
$right["right"][3]["right"][3] = array("view"=>1, "add"=>1, "save"=>1, "delete"=>1);
$right["right"][3]["right"][4] = array("view"=>1, "print"=>1);
$right["right"][3]["right"][5] = array("view"=>1, "print"=>1);
$right["right"][3]["right"][6] = array("view"=>1, "print"=>1);
$right["right"][3]["right"][7] = array("view"=>1, "print"=>1);
$right["right"][3]["right"][8] = array("view"=>1, "add"=>1, "save"=>1, "delete"=>1);
$right["right"][3]["right"][9] = array("view"=>1, "save"=>1, "delete"=>1, "print"=>1);
$right["right"][3]["right"][10] = array("view"=>1, "print"=>1);
$right["right"][3]["right"][11] = array("view"=>1, "print"=>1);
$right["right"][3]["right"][12] = array("view"=>1, "print"=>1);
*/
?>
